...
exports.up = async function up(knex) {
  ...
  await knex.schema.createTable('tr_template_reports', table => {
    ...
    table
      .string('template_report_template_name')
      .comment('Template Report template name to be used to render templates');
    table
      .json('template_report_input_body')
      .comment('input values to generate the template');
    table
